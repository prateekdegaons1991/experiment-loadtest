...
#
    ...
    def removeLoad(self, experimentsDetails):
        ...
        #Wait till pod complete

        err = self.CheckPodComplete(experimentsDetails, 0, experimentsDetails.Timeout, experimentsDetails.Delay)
        if err != None:
            return err
        logging.info("[Info]:Helper Pod is Completed")    
	
        #After completion of Load experiment Removing Pod Function is Calling
    ...
    def CheckPodComplete(self,experimentsDetails, init, timeout, delay):
        ...
        try:
            ...
            if str(resp.status.phase) != 'Succeeded':
